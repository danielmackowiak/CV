...
add_action('woocommerce_before_account_navigation', function () {
	...
	if (get_theme_mod('has_account_page_name', 'no') === 'yes') {
		$username = '<div class="ct-account-user-box">';
		...
		$username .= '<span><a href="' . $account_details_url . '">' . __('Account', 'blocksy') . '</a> <i>|</i> <a href="' . wc_logout_url() . '">' . __("Log out", 'blocksy') . '</a></span></div>';
	}
